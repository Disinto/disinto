<!-- last-reviewed: 63d6db4f27466434ca60d7f625d7cdd3d05f737c -->
...
| `acl-policies/chat-ops.hcl` | submitted via `lib/init/nomad/deploy.sh` | Nomad ACL policy for chat-Claude operator scope; grants submit-job, read-job, list-jobs, read-logs in default namespace, read on agents and nodes. |
