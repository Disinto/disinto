# =============================================================================
# nomad/jobs/agents-dev-qwen.hcl — dev-role agent job (local Qwen model)
#
# Per-role variant of nomad/jobs/agents.hcl for the dev-qwen bot: same image,
# volumes, and Vault-templated bot tokens, with AGENT_ROLES pinned to "dev".
# Runs against the local llama-server (ANTHROPIC_BASE_URL) instead of the
# Anthropic API.
#
...
EOT
      ...
      # nomad/jobs/agents.hcl. This job authenticates as the dev bot:
      # FORGE_TOKEN/FORGE_PASS come from kv/disinto/bots/dev.
      #
