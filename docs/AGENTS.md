...
├── tools/         Operational tools: edge-control/ (register.sh, install.sh; reserved-name
│                  blocklist, admin-approved allowlist, per-caller attribution); run-acceptance.sh
│                  — acceptance test runner for CI
